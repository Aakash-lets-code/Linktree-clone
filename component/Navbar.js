...
const Navbar = () => {
    ...
    return (<>{showNavbar && <nav className='w-[90vw] flex items-center justify-between fixed top-12 right-[5vw] rounded-full pl-10 pr-3.5 py-2.5 bg-white z-50 '>
                ...
                <Link href="/learn">
                    ...
                    <li onMouseEnter={handleLearnEnter} onMouseLeave={handleLearnLeave} className=' hover:bg-[#eff0ec] text-[#74776d] px-4 py-3 rounded-lg relative' > Learn
                        ...
                        {isLearnHovered && <> <div className='absolute left-0 top-full w-48 z-10 origin-top duration-500 bg-transparent' >
                            <div className='mt-7 px-2 py-1 bg-white rounded-lg shadow-lg '>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >The 2024 Creator Report</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >All Article</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >Creator</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >Trends</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >Best Practices</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >Company</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >Product News</div>
                                <div className=' p-4 py-3 rounded-lg hover:bg-[#eff0ec] my-1' >Help</div>
                            </div>
                        </div></>}
